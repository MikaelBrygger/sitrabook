...
<summary><em>Evoluution lyhyt historia vähän tarkemmin</em></summary>
...
| 4. Alustatalous (digitaalinen data)                       | Alustat, algoritmit, verkostot            | Keskitetty verkostokomputaatio: alustat näkivät koko verkoston ja optimoivat sitä reaaliajassa → ohjelmallinen koordinointi, mutta edelleen suljettu ja ekstraktiivinen talouslogiikka                         |
...
<summary><em>Mitä eri taloudelliset mediat mahdollistavat &#x26; mitä eivät<strong>?</strong></em></summary>
...
| 4. **Digitaalinen data & Alustatalous** (algoritmit, verkostot)                                   | <p>• Keskitetty verkostonäkökyky (“god-view”)<br>• Reaaliaikainen optimointi<br>• Käytettävyyden ja datan arvo</p>                                                           | <p>• Kyky oli keskitetty ja omistettu<br>• Omistajan "social graph exploitation and extraction"<br>• Talouden logiikka Read Only</p>                                                             |
| **5. Lohkoketjut & Jaettu tila** (konsensus, yhteinen ledger)                                     | <p>• Jaetun tilan omistus ilman keskusta<br>• Matemaattisesti tuotettu luottamus<br>• Säännöt suoritettiin hajautetusti</p>                                                  | <p>• Talouslogiikka jäi yksitasoiseksi (“one ledger, one token”)<br>• Ei kykyä ilmaista monimuotoista arvoa<br>• Taloudellinen merkitys laskettiin edelleen vanhalla keskitetyllä logiikalla</p> |
| **6. Ohjelmoitava talous & Distributed Economic Computation** (edge agency, protokollat, agentit) | <p>• Arvon monikielinen ilmaisu<br>• Arvonkalkyylin, laskennan ja governance-kerroksen siirtyminen reunoille<br>• Talouden suunnittelu, testaus ja päivitys protokollina</p> | <p>• Kehitys kesken: tarvitaan uudet protokollat (tämä on ECSA:n työn ydin)<br>• Tarvitaan institutionaalinen konteksti, jossa kokeilla uusia talouslogiikoita</p>                               |
