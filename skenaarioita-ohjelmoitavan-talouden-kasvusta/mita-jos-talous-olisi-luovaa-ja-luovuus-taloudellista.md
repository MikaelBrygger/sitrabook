---
icon: seedling
cover: ../.gitbook/assets/banner-scenario-3t.png
coverY: 0
layout:
  width: default
  cover:
...
Esimerkiksi Eve Sussmanin teokseen [_89 Seconds at Alcázar_](https://www.moma.org/collection/works/93645) (2004) perustuvassa projektissa [_89 Seconds Atomized_](https://dyor.kunsthallezurich.ch/seeders/snark-art/) (2018), Diego Velázquezin maalaus [_Las Meninas_](https://www.museodelprado.es/en/the-collection/art-work/las-meninas/9fdc7800-9ade-48b0-ab8b-edee94ea877f) (1656) muunnettiin videomateriaaliksi ja fragmentoitiin 2048 yksittäiseksi "atomiksi" eli pikseliksi, joista jokainen myytiin uniikkina teoksena. Arvo ei ollut enää ainoastaan kokonaisessa teoksessa, vaan myös sen yksittäisissä osissa, jotka antoivat käyttäjilleen omistajuuden lisäksi oikeuden lainata toisten omistamia pikseleitä tai antaa omansa lainaan.&#x20;
...
Derivointi on strategia, jossa yhdestä lähdemateriaalista versioidaan useita erilaisia versioita, kokemuksia ja tarjouksia. Toisin kuin hajottamisessa, alkuperäistä teosta ei pureta, vaan siitä luodaan rinnakkaisia "otoksia" eri yleisöjen tarpeisiin. Tämän mekanismin eräs ilmentymä ovat joukkorahoituskampanjoiden eri tukitasot (reward-tier). Perustuote – esimerkiksi kirja – pysyy samana, mutta siitä derivoidaan monipuolinen valikoima tarjouksia: viiden euron sähköinen PDF-versio, 50 euron fyysinen kirja ja 200 euron oheismateriaaleja sisältävä deluxe-versio.&#x20;
...
Luova tarjoaminen on tällaisten mekanismien synteesi, jossa todellinen innovaatio tapahtuu. Se on käytäntö, jossa muun muassa osiin hajottamista, derivointia ja ajan hyödyntämistä yhdistellään kekseliäästi täysin uusiksi taloudellisiksi ja sosiaalisiksi rakennelmiksi. Tällöin huomio siirtyy perinteisestä tuotteiden myymisestä kohti suhteiden ja kokonaisuuksien muotoilua. _89 Seconds Atomized_ toimii tästä konkreettisena esimerkkinä: teos on pilkottu 2 304 videopikseliin, ja jokaisen pikselin omistaja voi paitsi hallita omaa omaansa, myös lainata sitä eteenpäin muiden pikselien haltijoiden käytettäväksi ja esitettäväksi. Näin teos muuttuu pelkän esineen sijaan yhteisölliseksi rakennelmaksi, jonka merkitys ja koettavuus rakentuvat atomien jakamisen, lainaamisen ja katselun verkostossa.
